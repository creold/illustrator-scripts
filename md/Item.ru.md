...
Версия Lite (FitSelectionToArtboards-Lite.jsx) без диалога выравнивает и масштабирует верхний выбранный объект по артборду, на котором он находится полностью или частично. Если в коде отредактировать `CFG.isContains:false`, то объект за пределами активного артборда будет помещён в него.
