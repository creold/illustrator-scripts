/*
  ...
  for selected swatches or all document swatches from a list of over 4,877 names.
...
var HEX_DATA_0 = [
      ...
      {name: 'Blue Fjord', hex: '#007290'},
      {name: 'Blue Hour', hex: '#0034ab'},
      {name: 'Blue Ocean', hex: '#009dc4'},
      ...
      {name: 'Oxford by Night', hex: '#001b2e'},
      ...
      {name: 'Raging Thunderstorm', hex: '#004f63'},
      ...
      {name: 'Shadows of Time', hex: '#018466'},
      {name: 'Shamrock', hex: '#009e60'},
      {name: 'Silent Twilight', hex: '#0f084b'},
      ...
      {name: 'Whole Nine Yards', hex: '#03c03c'},
...
var HEX_DATA_1 = [
      ...
      {name: 'Aegean Blue', hex: '#1b416f'},
      {name: 'Always Greener Grass', hex: '#11aa00'},
      ...
      {name: 'Lightsaber Blue', hex: '#15f2fd'},
      ...
      {name: 'Midnight Monarch', hex: '#1c0f33'},
      ...
      {name: 'Shot in the Dark', hex: '#1d0d1d'},
      {name: 'Silken Jade', hex: '#11a39e'},
      {name: 'Sinister', hex: '#12110e'},
      {name: 'Sombre Night', hex: '#161e34'},
      {name: 'Sooty', hex: '#141414'},
      {name: 'Soulless', hex: '#1b150d'},
      {name: 'Space Colonisation', hex: '#150f5b'},
      {name: 'Spring Forth', hex: '#11bb22'},
      {name: 'Sunken Harbour', hex: '#1c3d44'},
      {name: 'Sunken Ship', hex: '#10252a'},
...
var HEX_DATA_2 = [
      ...
      {name: 'Depths of the Nile', hex: '#253f4e'},
      ...
      {name: 'Indie Go', hex: '#2e2364'},
      {name: 'Infinite Inkwell', hex: '#2f1064'},
      ...
      {name: 'Magical Malachite', hex: '#22cc88'},
      {name: 'Mallard', hex: '#254855'},
      {name: 'Marshland', hex: '#2b2e26'},
      {name: 'Matt Blue', hex: '#2c6fbb'},
      {name: 'Mediaeval Blue', hex: '#2e3858'},
      {name: 'Midnight Escapade', hex: '#2b3458'},
      ...
      {name: 'Monster Monstera', hex: '#2f8351'},
...
var HEX_DATA_3 = [
      ...
      {name: 'Blue Burst', hex: '#309cd0'},
      {name: 'Blue Moon', hex: '#3992a8'},
      {name: 'Bluebell', hex: '#333399'},
      {name: 'Bluedgeons', hex: '#324c64'},
      ...
      {name: 'Close but No Cigar', hex: '#361d0a'},
      ...
      {name: 'Cucumber Queen', hex: '#3c773c'},
      ...
      {name: 'Enchanted Well', hex: '#3994af'},
      ...
      {name: 'Forlorn Cruise', hex: '#34466c'},
      ...
      {name: 'Grass Is Greener', hex: '#3f9b0b'},
      {name: 'Great Void', hex: '#3b5760'},
      {name: 'Green Sleeves', hex: '#39766c'},
      {name: 'Greenhouse', hex: '#3e6334'},
      {name: 'Havana', hex: '#3b2b2c'},
      {name: 'Herbes de Provence', hex: '#3a5f49'},
      ...
      {name: 'Queen of the Night Shift', hex: '#3d4585'},
      {name: 'Resplendent Growth', hex: '#3d8b37'},
      {name: 'Romanic Scene', hex: '#3b0346'},
      {name: 'Sanctum of Shadows', hex: '#3c2f4e'},
      ...
      {name: 'Six Feet Under', hex: '#3d322e'},
      ...
      {name: 'Stargazer', hex: '#3f5865'},
      {name: 'Starless Night', hex: '#3e4855'},
      ...
      {name: 'Tempest in a Teapot', hex: '#303a40'},
      {name: 'Toad King', hex: '#3d6c54'},
      {name: 'Total Eclipse', hex: '#303543'},
      {name: 'Try Your Luck', hex: '#34b334'},
...
var HEX_DATA_4 = [
      ...
      {name: 'Deepest Nightmare', hex: '#44413c'},
      {name: 'Délicieux au Chocolat', hex: '#412010'},
      {name: 'Descent Into the Catacombs', hex: '#445155'},
      ...
      {name: 'Galactic Compass', hex: '#48357b'},
      ...
      {name: 'Rogue Waters', hex: '#4e7376'},
      {name: 'Rosemary', hex: '#405e5c'},
      {name: 'Royal Blue', hex: '#4169e1'},
      {name: 'Royal Crown', hex: '#4f325e'},
      ...
      {name: 'Skies of Cyberspace', hex: '#4477dd'},
      {name: 'Sky Dancer', hex: '#4499ff'},
      {name: 'Song of the Sea', hex: '#4a73a8'},
      {name: 'Sooty Lashes', hex: '#474d52'},
      ...
      {name: 'Still Waters Run Deep', hex: '#4a5d5f'},
      ...
      {name: 'Under the Radar', hex: '#476e42'},
      ...
      {name: 'Void Wellness Coach', hex: '#41373a'},
      {name: 'Voodoo', hex: '#443240'},
      {name: 'Vulcanised', hex: '#424443'},
...
var HEX_DATA_5 = [
      ...
      {name: 'Crucible', hex: '#555b59'},
      {name: 'Cypress', hex: '#585d40'},
      {name: 'Dark Forest', hex: '#556962'},
      {name: 'Drifting Violet', hex: '#5b4276'},
      ...
      {name: 'Knight’s Armour', hex: '#5c5d5d'},
      ...
      {name: 'Shepherd’s Green', hex: '#5a8643'},
      {name: 'Silent Night', hex: '#526771'},
      {name: 'Skinny Jeans', hex: '#5588ff'},
      {name: 'Smokescreen', hex: '#5e5755'},
      {name: 'Soul Anchor', hex: '#5c1c39'},
      {name: 'Space Opera', hex: '#5511dd'},
      {name: 'Stone Cold', hex: '#555555'},
      {name: 'Stream Burble', hex: '#5e7e7d'},
      ...
      {name: 'Winter Lake', hex: '#5c97cf'},
      {name: 'Wizard’s Potion', hex: '#5d6098'},
...
var HEX_DATA_6 = [
      ...
      {name: 'Archaeology', hex: '#6e6a5e'},
      {name: 'Arctic', hex: '#648589'},
      {name: 'Armoury', hex: '#6a6b65'},
      {name: 'Ashen Whisper', hex: '#646b7a'},
      ...
      {name: 'Catch of the Day', hex: '#6c685e'},
      ...
      {name: 'Forbidden Passion', hex: '#661020'},
      ...
      {name: 'Ultrapurple Merge', hex: '#654ea3'},
...
var HEX_DATA_7 = [
      ...
      {name: 'Magician’s Cloak', hex: '#784467'},
      ...
      {name: 'Poisoning Purple', hex: '#7f01fe'},
      ...
      {name: 'Shredder Lavender', hex: '#7737aa'},
      {name: 'Silver Surfer', hex: '#7e7d88'},
      {name: 'Simply Purple', hex: '#715bb1'},
      {name: 'Single Origin', hex: '#713e39'},
      {name: 'Sky', hex: '#76d6ff'},
      {name: 'Smoky Studio', hex: '#7e8590'},
      {name: 'Soon to Be Hay', hex: '#7bb369'},
      {name: 'Stone Age Queen', hex: '#7a3f2b'},
      {name: 'Stonewash', hex: '#74819a'},
      ...
      {name: 'Veil of Cinder', hex: '#784f50'},
...
var HEX_DATA_8 = [
      ...
      {name: 'Cerulean Skies', hex: '#8cc6cb'},
      ...
      {name: 'Chorus of Elephants', hex: '#8e8987'},
      {name: 'Chorus of Frogs', hex: '#8c9632'},
      ...
      {name: 'Midnight Aubergine', hex: '#853c69'},
      ...
      {name: 'Nuts and Bolts', hex: '#898c92'},
      ...
      {name: 'Paradisiacal Getaway', hex: '#8ddee1'},
      ...
      {name: 'Shore', hex: '#81d5c6'},
      {name: 'Silk Satin', hex: '#8b4248'},
      {name: 'Silverfish', hex: '#8d95aa'},
      {name: 'Sizzling Bacon', hex: '#8e3537'},
      {name: 'Sky Fall', hex: '#89c6df'},
      {name: 'Sleepy Hollow', hex: '#839c6d'},
...
var HEX_DATA_9 = [
      ...
      {name: 'Amazon Queen', hex: '#948f54'},
      {name: 'Amethyst', hex: '#9966cc'},
      {name: 'Amorous', hex: '#967d96'},
      {name: 'Ancient Chest', hex: '#99522b'},
      ...
      {name: 'Chilli Con Carne', hex: '#985e2b'},
      ...
      {name: 'Crown Jewels', hex: '#946dad'},
      {name: 'Dark Ages', hex: '#9698a3'},
      {name: 'Decreasing Brown', hex: '#987654'},
      {name: 'Dreamscape Purple', hex: '#9632ce'},
      ...
      {name: 'Neptune’s Realm', hex: '#97c0d1'},
      ...
      {name: 'Spill the Beans', hex: '#9b351b'},
      ...
      {name: 'Swamp Sessions', hex: '#93977f'},
      {name: 'Tahini Brown', hex: '#9b856b'},
      {name: 'Tamed Beast', hex: '#9c2626'},
      {name: 'Thorne Wines', hex: '#9c2d5d'},
...
var HEX_DATA_A = [
      ...
      {name: 'Caramelised Pecan', hex: '#a17b4d'},
      ...
      {name: 'Cherry on Top', hex: '#ac495c'},
      {name: 'Chilli Pepper', hex: '#ac1e3a'},
      {name: 'Chocolate Chilli', hex: '#ab4231'},
      ...
      {name: 'Funky Monkey', hex: '#ad4e1a'},
      {name: 'Garden of Earthly Delights', hex: '#a09f5b'},
      ...
      {name: 'Imperial Lilac', hex: '#a99fcf'},
      ...
      {name: 'Tender Shoot', hex: '#accb35'},
      {name: 'Toasted Paprika', hex: '#a34631'},
      {name: 'Tomato Sunrise', hex: '#aa251b'},
      ...
      {name: 'Violet Voltage', hex: '#a669db'},
...
var HEX_DATA_B = [
      ...
      {name: 'Botticelli', hex: '#b70272'},
      {name: 'Brass', hex: '#b5a642'},
      {name: 'Break the Ice', hex: '#b2e1ee'},
      {name: 'Breaking the Ice', hex: '#b8e4f5'},
      ...
      {name: 'Cut the Mustard', hex: '#ba7f38'},
      ...
      {name: 'Extravagant Blush', hex: '#b55067'},
      {name: 'Faded Letter', hex: '#bfac86'},
      {name: 'Faint Gold', hex: '#b59410'},
      {name: 'Fallen Canopy', hex: '#b85824'},
      ...
      {name: 'Nebulous December', hex: '#b3b2bf'},
      ...
      {name: 'Pick Your Poison', hex: '#bff128'},
      ...
      {name: 'Pomegranate', hex: '#b53d45'},
      {name: 'Poolside', hex: '#bee0e2'},
      {name: 'Promiscuous Pink', hex: '#bb11ee'},
      {name: 'Punched Pink', hex: '#b68692'},
      ...
      {name: 'Serpent Sceptre', hex: '#bbcc00'},
      ...
      {name: 'The Big Freeze', hex: '#bbffff'},
      {name: 'The Grape War of 97’', hex: '#bb00ff'},
      {name: 'Tiger', hex: '#be9c67'},
      {name: 'Timeless Beauty', hex: '#b6273e'},
      {name: 'Tip of the Iceberg', hex: '#bbe4ea'},
      {name: 'Titian Red', hex: '#bd5620'},
      {name: 'Toadstool', hex: '#b8282f'},
      {name: 'Too Hot to Handle', hex: '#bf6153'},
      {name: 'Trade Winds', hex: '#b7c5c6'},
      {name: 'Treasures', hex: '#ba8b36'},
      {name: 'Turnip Crown', hex: '#bb9ecd'},
      {name: 'Upset Tomato', hex: '#b52923'},
...
var HEX_DATA_C = [
      ...
      {name: 'Alligator Alley', hex: '#c5d17b'},
      ...
      {name: 'Chopped Almonds', hex: '#c7bca1'},
      ...
      {name: 'Digital Lavender', hex: '#cac0e1'},
      {name: 'Dim', hex: '#c8c2be'},
      {name: 'Dinosaur Egg', hex: '#cabaa9'},
      {name: 'Diva', hex: '#c9a0ff'},
      {name: 'Dream Vapour', hex: '#cc99ee'},
      ...
      {name: 'Forgotten Tusk', hex: '#c4bba5'},
      {name: 'Fox', hex: '#ca4e33'},
      ...
      {name: 'Maine Coon Orange', hex: '#c2792b'},
      ...
      {name: 'Sprinkled With Dew', hex: '#cfecee'},
      ...
      {name: 'Sunken Treasure', hex: '#cccf86'},
      ...
      {name: 'Thai Chilli', hex: '#ce0001'},
      {name: 'The Weight of Gold', hex: '#cdbb63'},
...
var HEX_DATA_D = [
      ...
      {name: 'Airy', hex: '#dae6e9'},
      {name: 'Airy Fields', hex: '#dbe0c4'},
      {name: 'Alaska', hex: '#dadad1'},
      {name: 'Anarchist', hex: '#db304a'},
      {name: 'Ancestral Gold', hex: '#ddcda6'},
      ...
      {name: 'Bare Mintimum', hex: '#d6e3e7'},
      {name: 'Beefy Pink', hex: '#debeef'},
      {name: 'Beet Wave', hex: '#d4265d'},
      ...
      {name: 'Deadly Mustard', hex: '#dead11'},
      ...
      {name: 'Freezing Vapour', hex: '#d4e9f5'},
      ...
      {name: 'Gin', hex: '#d9dfcd'},
      {name: 'Girl Crush', hex: '#d1c0dc'},
      {name: 'Girl Power', hex: '#d39bcb'},
      {name: 'Gliding Feather', hex: '#d7d8d9'},
      ...
      {name: 'Oldies but Goldies', hex: '#d6b63d'},
      {name: 'Olympus White', hex: '#d4d8d7'},
      {name: 'On Thin Ice', hex: '#d1e8f1'},
      ...
      {name: 'Queen of Waves', hex: '#d2eaea'},
      {name: 'Quiet Dew', hex: '#d7d9d5'},
      ...
      {name: 'Savoury Salmon', hex: '#d19c97'},
      {name: 'Second Wind', hex: '#dfece9'},
      ...
      {name: 'Sun-Kissed Beach', hex: '#deab9b'},
      {name: 'Sunny Disposition', hex: '#dba637'},
      {name: 'Sunspill', hex: '#ddc283'},
      ...
      {name: 'Velvet Horizon', hex: '#d39ed2'},
      ...
      {name: 'Winter’s Breath', hex: '#deeced'},
      {name: 'Wishing Well', hex: '#d0d1c1'},
      {name: 'York Pink', hex: '#d7837f'},
      {name: 'York Plum', hex: '#d3bfe5'},
      {name: 'Young at Heart', hex: '#d5a1a9'},
      {name: 'Yuzukosh?', hex: '#d4de49'},
      {name: 'Zen Garden', hex: '#d1dac0'},
      {name: 'Zombie', hex: '#dadead'}
    ];

var HEX_DATA_E = [
      {name: '24 Carrot', hex: '#e56e24'},
      {name: 'Alarm', hex: '#ec0003'},
      {name: 'Albescent', hex: '#e1dacb'},
      {name: 'Almond', hex: '#eddcc8'},
      {name: 'Almond Brittle', hex: '#e5d3b9'},
      {name: 'Amor', hex: '#ee3377'},
      {name: 'Amour', hex: '#ee5851'},
      {name: 'Ancient Treasure', hex: '#e7d082'},
      ...
      {name: 'Baptism by Fire', hex: '#e6490b'},
      {name: 'Barberry', hex: '#ee1133'},
      {name: 'Barbiecore', hex: '#e15acb'},
      ...
      {name: 'Blackberry Yoghurt', hex: '#e5bddf'},
      {name: 'Blanco', hex: '#ebeae5'},
      {name: 'Blazing', hex: '#e94e41'},
      {name: 'Blissful Serenity', hex: '#eaeed8'},
      {name: 'Blood Donor', hex: '#ea1822'},
      {name: 'Blood of My Enemies', hex: '#e0413a'},
      ...
      {name: 'Caramel Essence', hex: '#e3af64'},
      ...
      {name: 'Celery Sceptre', hex: '#e1df9a'},
      ...
      {name: 'Cosy Summer Sunset', hex: '#eb9f9f'},
      ...
      {name: 'Delicate Bliss', hex: '#ede0d5'},
      ...
      {name: 'Diamonds in the Sky', hex: '#e5e2e1'},
      ...
      {name: 'Distant Wind Chime', hex: '#eaeff2'},
      ...
      {name: 'Furious Piñata', hex: '#e34d41'},
      ...
      {name: 'Heirloom Blush', hex: '#e3664c'},
      ...
      {name: 'Homoeopathic Green', hex: '#e1ebd8'},
      {name: 'Homoeopathic Lavender', hex: '#e5e0ec'},
      {name: 'Homoeopathic Lilac', hex: '#e1e0eb'},
      {name: 'Homoeopathic Lime', hex: '#e9f6e2'},
      {name: 'Homoeopathic Mint', hex: '#e5ead8'},
      {name: 'Homoeopathic Red', hex: '#ecdbe0'},
      {name: 'Homoeopathic Rose', hex: '#e8dbdd'},
      {name: 'Homoeopathic Yellow', hex: '#ede7d7'},
      ...
      {name: 'Land of Dreams', hex: '#edabe6'},
      {name: 'Last Straw', hex: '#e3dbcd'},
      {name: 'Lava Pit', hex: '#e46f34'},
      {name: 'Le Bon Dijon', hex: '#e4cb6b'},
      ...
      {name: 'Pharaoh’s Gold', hex: '#ead765'},
      ...
      {name: 'Star Magnolia', hex: '#eeefe2'},
      {name: 'Starlet Pink', hex: '#edc2db'},
      ...
      {name: 'Sulphur Pit', hex: '#e5cc69'},
      {name: 'Sulphuric', hex: '#eeed56'},
...
var HEX_DATA_F = [
      ...
      {name: 'Acropolis', hex: '#f8e2ca'},
      {name: 'Air-Kiss', hex: '#f6dcd2'},
      {name: 'Alpaca', hex: '#f9ede2'},
      ...
      {name: 'Bread and Butter', hex: '#ffd182'},
      ...
      {name: 'Bubblegum Beam', hex: '#f887c7'},
      ...
      {name: 'Cloud Dancer', hex: '#f1eee8'},
      {name: 'Cloud Number Nine', hex: '#f9cec6'},
      {name: 'Cloud of Cream', hex: '#f1e2c4'},
      ...
      {name: 'Crème Pâtissière', hex: '#fdd77a'},
      {name: 'Cumulus', hex: '#f3f3e6'},
      {name: 'Cup Noodles', hex: '#fedd7d'},
      ...
      {name: 'Deep Fried Sunrays', hex: '#f6c75e'},
      ...
      {name: 'Double Dragon', hex: '#fca044'},
      {name: 'Dove’s Wing', hex: '#f4f2ea'},
      {name: 'Down Feathers', hex: '#fff9e7'},
      {name: 'Dr. White', hex: '#fafafa'},
      {name: 'Dragon Ball', hex: '#ff9922'},
      {name: 'Dragon’s Fire', hex: '#fc4a14'},
      ...
      {name: 'Dwindling Dandelion', hex: '#f9e9d6'},
      ...
      {name: 'Golden Ticket', hex: '#f5cc23'},
      {name: 'Goldenrod', hex: '#fdcb18'},
      ...
      {name: 'Grannie’s Pearls', hex: '#f6eeed'},
      ...
      {name: 'Homoeopathic Orange', hex: '#f2e6e1'},
      ...
      {name: 'Mellow Dandelion', hex: '#f8de7f'},
      ...
      {name: 'Milk Moustache', hex: '#faf3e6'},
      ...
      {name: 'Pick Your Brain', hex: '#f1919a'},
      ...
      {name: 'Plastic Cheese', hex: '#ffcc04'},
      ...
      {name: 'Porcelain Blush', hex: '#f0dbd5'},
      ...
      {name: 'Strawberry Cheesecake', hex: '#ffdbe9'},
      ...
      {name: 'Vapour', hex: '#f0ffff'},
      {name: 'Vapour Trail', hex: '#f5eedf'},
      {name: 'Veiled Rose', hex: '#f7cdc8'},
      {name: 'Veiled Treasure', hex: '#f6edb6'},
      {name: 'Venerable White', hex: '#f7f5f3'},
...
function main() {
  ...
  /**
   * Process the renaming of swatches and handles validation/conflict warnings
   */
  function process() {
    var failures = renameSwatches(selSwatches, editedNames);

    if (failures.length > 0) {
      var msg = 'Warning\nThe following names cannot be used for a spot color because it is reserved:\n\n';
      msg += failures.join('\n');
      msg += '\n\nPlease fix these names to proceed.';
      alert(msg, 'Script Notice');
      return;
    }

    if (typeof existsCount !== 'undefined' && existsCount) {
  ...
  /**
   * Update the input text fields with the current page of edited swatch names
   */
  ...
  /**
   * Save the current page of edited names back to the `editedNames` array
   */
 ...
 * @returns {Array} failedNames - Array of error strings. Empty if successful
 */
function renameSwatches(swatches, names) {
  var failedNames = [];
  if (!names.length || !swatches.length) return failedNames;
  ...
  for (var i = 0; i < len; i++) {
    try {
      ...
      failedNames.push(swatches[i].name + ' > ' + names[i]);
    }
  }
  ...
  for (var i = 0, len = swatches.length; i < len; i++) {
    ...
    switch (true) {
      ...
      case /#2/i.test(swHex):
        ...
        break;
      case /#3/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_3, tolerance);
        break;
      case /#4/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_4, tolerance);
        break;
      case /#5/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_5, tolerance);
        break;
      case /#6/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_6, tolerance);
        break;
      case /#7/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_7, tolerance);
        break;
      case /#8/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_8, tolerance);
        break;
      case /#9/i.test(swHex):
        matchedName = findMatches(swHex, HEX_DATA_9, tolerance);
        break;
      case /#a/i.test(swHex):
